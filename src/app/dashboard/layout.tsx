...
const activityItems = [
  {
    ...
    description: "Em rota para unidade de beneficiamento",
    date: "1h",
...
const teams = [
  { id: 1, name: "Carajás-05", href: "#", initial: "C", current: false },
  { id: 2, name: "Carajás-07", href: "#", initial: "C", current: false },
  { id: 3, name: "Goiás-01", href: "#", initial: "G", current: false },
];
              ...
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  ...
                  >
                    ...
                    <span aria-hidden="true">Usuário</span>
                  </a>
                </li>
              </ul>
            </nav>
